...
<div class="advanced-article-content-wrapper clearfix row ">
  ...
  <div class="advanced-article-advanced-content col-lg-4 col-md-4 col-sm-6 col-xs-12">
    <?php
      foreach ($advanced_content_order as $field => $weight):
    ?>
      <?php
        if (!empty($content[$field])):
      ?>
        <div class="article-adv-content-field advanced-article-<?php print $field; ?>">
          <?php
