    ...
    <div class="issue-notes col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="row">
          <?php if (!empty($content['body']) || !empty($content['body']) || !empty($content['body'])) {
            ...
            $mobile_class = 'col-xs-12';
          }
          ?>
          <div class="issue-cover-image col-lg-12 col-md-12 col-sm-12 <?php print $mobile_class; ?>">
            <?php print render($content['field_issue_image']); ?>
          </div>
          <div class="issue-notes-content col-lg-12 col-md-12 col-sm-12 <?php print $mobile_class; ?>">
